...
## Header
- Logo/wordmark treatment: "FITLAT" set in the display grotesk, all caps, tight tracking, no icon mark. The wordmark carries the whole thing on its own — nothing sitting next to it.
...
- Subheading/intro line: A look at the floor, not a stock photo of one.
- Image captions (list, one per planned image):
  1. Main lifting platforms, 6am
  2. Turf sled track, east wall
  3. Recovery room
  4. Free weight section
...
- Tier 1 — Student: $39/mo, billed monthly, valid student ID required — floor access, group classes, locker room, no lock-in contract
- Tier 2 — Casual: $79/mo, billed monthly — everything in Student, plus open coaching hours, guest passes (2/mo), extended hours access
- Tier 3 — Professional Athlete: $149/mo, billed monthly, application required — everything in Casual, plus individualized programming, recovery room priority booking, direct coach access, competition prep support
